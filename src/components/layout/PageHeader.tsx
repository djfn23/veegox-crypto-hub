...
import { MobileHeading, MobileText } from "@/components/ui/mobile-components"
    ...
    <div className={cn("mb-6", className)}>
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <MobileHeading level={1} className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              {title}
            </MobileHeading>
            {subtitle && (
